    ...
    <main class="main">
      <div class="page__contents -dark">
        <section class="news">
          ...
          <div class="inner__md">
            <ul class="news__lists -archive wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
              <li class="news__list">
            ...
            <a href="" class="news__readmore wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
              もっと見る
            </a>
          </div>
        </section>
