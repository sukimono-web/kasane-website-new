// src/pages/grand-opening.tsx
export const GrandOpeningPage = () => (
  <>
    <header class="header">
      ...
      <div class="page__contents -dark">
        <section class="news">
          ...
          <div class="s-news__wrap wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
            ...
            <h2 class="s-news__title">7/30（土）、グランドオープン決定！</h2>
            <div class="s-news__contents">
              <p>
                有福温泉にこの度、新たにオープンいたします
                <br />
              ...
              <p>※料金、お食事についてのご案内は、後日となります。</p>
              <p>どうぞお気軽にお問合せください。</p>
              <p>
                【お問合せ先】
                <br />
                TEL／0855-56-0011（Showcase Hotel KASANE）
                <br />
                TEL／0855-52-7556（SUKIMONO株式会社）
              </p>
            </div>
          </div>
