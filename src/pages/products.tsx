      ...
      <div class="page__contents">
        <div class="inner__lg">
          ...
          <p class="p-lead -sm wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
            江津市に本社を置くSUKIMONO。
            <br />
            建築デザイン、家具、布製品は"無為自然"の思いのもとにつくりあげ、
            <br />
            使い手の幸せへつないでいきます。
          </p>
          <p class="p-text wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
            デザイナー、設計者、職人それぞれがひとつひとつ丁寧に作り上げるプロダクト。
            <span class="is-br">
              SUKIMONOが初めて手がける自社ホテルKASANEには、特別なプロダクトが揃っています。
            </span>
          </p>

          <div class="comingsoon wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
            Coming soon
          </div>
        </div>
      </div>
